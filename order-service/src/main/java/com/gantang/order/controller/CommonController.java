package com.gantang.order.controller;
...
import com.gantang.order.service.TestService;
...
public class CommonController {
    ...
    @ResponseBody
    public Result orderInterface() {
//        try{
            Map<String, String> selectMap = new HashMap<>();
            selectMap.put("table", "sys_user");
            return commonService.orderInterface(selectMap);
//        }catch (Exception e){
//            e.printStackTrace();
