package com.gantang.interfaces;
...
@MapperScan(basePackages = {"com.gantang.interfaces.mapper","com.gantang.core.mapper"})
@ComponentScan(basePackages = {"com.gantang.interfaces", "com.gantang.common", "com.gantang.core"})
@EnableTransactionManagement
@EnableDiscoveryClient
@EnableFeignClients
@EnableDistributedTransaction
public class InterfacesApplication {
    private  static Logger log = LoggerFactory.getLogger(InterfacesApplication.class);
    public static void main(String[] args){
        SpringApplication.run(InterfacesApplication.class, args);
        log.info("甘棠第三方接口服务系统启动！！");
    }
}
